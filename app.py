...
mlflow.set_experiment("Text-to-Image Generation")
...
if st.button("🎨 Generate Image(s)"):
    with st.spinner('🔄 Generating image(s)...'):
        ...
        image_paths = generate_images(text_description, width=width, height=height, steps=num_inference_steps, guidance_scale=guidance_scale, num_images=num_images)
